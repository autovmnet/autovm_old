...
class Os extends \yii\db\ActiveRecord
{
    ...
    public static function getGuests()
    {
        return [
            ...
            'winNetEnterprise64' => 'Windows 2003 64 bit',
            'winLonghorn' => 'Windows 2008 32 bit',
            'winLonghorn64' => 'Windows 2008 64 bit',
            'windows8Server64' => 'Windows 2012 64 bit',
            'windows9Server64' => 'Windows 2016 64 bit',
